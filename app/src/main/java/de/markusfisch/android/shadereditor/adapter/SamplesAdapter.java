...
public class SamplesAdapter extends BaseAdapter {
	...
	public SamplesAdapter(Context context) {
		samples = new Sample[]{
				...
				new Sample(R.raw.sample_gravitational_clock,
						R.drawable.thumbnail_default,
						context.getString(R.string.sample_gravitational_clock_name),
						context.getString(R.string.sample_gravitational_clock_rationale)),
